...
namespace hazedumper {
	...
	namespace signatures {
		...
		#define dwForceAttack 0x320DE5C
		#define dwForceAttack2 0x320DE68
		#define dwForceBackward 0x320DE08
		#define dwForceForward 0x320DE8C
		#define dwForceJump 0x528791C
		#define dwForceLeft 0x320DE14
		#define dwForceRight 0x320DE20
		#define dwGameDir 0x62B900
		#define dwGameRulesProxy 0x52FB14C
		#define dwGetAllClasses 0xDEBCAC
		#define dwGlobalVars 0x58CCE0
		#define dwGlowObjectManager 0x5326638
		#define dwInput 0x522EF10
		#define dwInterfaceLinkList 0x970944
		#define dwLocalPlayer 0xDC14CC
		#define dwMouseEnable 0xDC71D8
		#define dwMouseEnablePtr 0xDC71A8
		#define dwPlayerResource 0x320C1A0
		#define dwRadarBase 0x52126B4
		#define dwSensitivity 0xDC7074
		#define dwSensitivityPtr 0xDC7048
		#define dwSetClanTag 0x8A410
		#define dwViewMatrix 0x4DCF254
		#define dwWeaponTable 0x522F9D4
		#define dwWeaponTableIndex 0x326C
		#define dwYawPtr 0xDC6E38
		#define dwZoomSensitivityRatioPtr 0xDCD620
		#define dwbSendPackets 0xD8632
		#define dwppDirect3DDevice9 0xA6050
		#define find_hud_element 0x57675CF0
		#define force_update_spectator_glow 0x3BE5EA
		#define interface_engine_cvar 0x3EA3C
		#define is_c4_owner 0x3CB670
		#define m_bDormant 0xED
		#define m_bIsLocalPlayer 0x3628
		#define m_flSpawnTime 0x103C0
		#define m_pStudioHdr 0x2950
		#define m_pitchClassPtr 0x5212950
